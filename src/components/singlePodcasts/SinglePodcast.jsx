      ...
      <div className="singlePodcastWrapper">
        ...
        {updateMode ? (
          <input
            type="text"
            value={title}
            className="singlePodcastTitleInput"
            autoFocus
        ...
        <div className="singlePodcastInfo">
          <span className="singlePodcastAuthor">
            Author:
          ...
          <span className="singlePodcastDate">
            {moment(podcast.createdAt).format("MMMM Do YYYY, h:mm a")}
          </span>
        </div>
        {updateMode ? (
          <textarea
            className="singlePodcastDescInput"
            value={desc}
            onChange={(e) => setDesc(e.target.value)}
          />
        ) : (
          <p className="singlePodcastDesc">{desc}</p>
        )}

        {updateMode && (
          <button className="singlePodcastButton" onClick={handleUpdate}>
            Update
          </button>
        )}
      </div>
